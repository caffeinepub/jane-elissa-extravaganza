...
export const VideoMethod = IDL.Variant({
...
export const idlService = IDL.Service({
  ...
  'getAppById' : IDL.Func([IDL.Text], [Application], ['query']),
  'getCallerUserProfile' : IDL.Func([], [IDL.Opt(UserProfile)], ['query']),
  'getCallerUserRole' : IDL.Func([], [UserRole], ['query']),
  'getStatus' : IDL.Func([IDL.Text], [PaymentStatus], ['query']),
  ...
  'setSitePublishedState' : IDL.Func([IDL.Bool], [], []),
  'setStripeConfiguration' : IDL.Func([StripeConfiguration], [], []),
  'submitApplication' : IDL.Func([Application], [], []),
  'transform' : IDL.Func(
      [TransformationInput],
      [TransformationOutput],
      ['query'],
    ),
  'updateStatus' : IDL.Func([IDL.Text, PaymentStatus], [], []),
});
