...
import type { Application as _Application, ExternalBlob as _ExternalBlob, PaymentStatus as _PaymentStatus, StripeSessionStatus as _StripeSessionStatus, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, VideoMethod as _VideoMethod, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAppById(arg0: string): Promise<Application> {
        if (this.processError) {
            try {
    ...
    async getStatus(arg0: string): Promise<PaymentStatus> {
        if (this.processError) {
            try {
    ...
    async setSitePublishedState(arg0: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setSitePublishedState(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitApplication(arg0: Application): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitApplication(await to_candid_Application_n25(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStatus(arg0: string, arg1: PaymentStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStatus(arg0, to_candid_PaymentStatus_n27(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_VideoMethod_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VideoMethod): Promise<VideoMethod> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        videoMethod: await from_candid_VideoMethod_n15(_uploadFile, _downloadFile, value.videoMethod),
        phone: value.phone,
...
async function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "youtubeLink" in value ? {
        __kind__: "youtubeLink",
        youtubeLink: value.youtubeLink
    } : "uploaded" in value ? {
        __kind__: "uploaded",
        uploaded: await from_candid_ExternalBlob_n17(_uploadFile, _downloadFile, value.uploaded)
    } : value;
}
...
async function to_candid_Application_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Application): Promise<_Application> {
...
async function to_candid_VideoMethod_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: VideoMethod): Promise<_VideoMethod> {
    return await to_candid_variant_n30(_uploadFile, _downloadFile, value);
}
...
async function to_candid_record_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        fullName: value.fullName,
        email: value.email,
        videoMethod: await to_candid_VideoMethod_n29(_uploadFile, _downloadFile, value.videoMethod),
        phone: value.phone,
        paymentIntentId: value.paymentIntentId
    };
}
...
async function to_candid_variant_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return value.__kind__ === "youtubeLink" ? {
        youtubeLink: value.youtubeLink
    } : value.__kind__ === "uploaded" ? {
        uploaded: await to_candid_ExternalBlob_n31(_uploadFile, _downloadFile, value.uploaded)
    } : value;
}
